		...
		<div>
			<div style="display:flex;">
				...
				<div style="margin-left:200px;">
					<button onclick="window.location.href='home'" style="background-color:#FF3C3C;border:5px solid #FF3C3C;border-radius:5px;color:white;">Keluar</button
					<br>
				</div>
			</div>
			<div style="display:flex;margin-top:30px;">
				<div style="margin-left:350px;padding:5px 90px;background-color:#D8D8D8;border:5px solid #D8D8D8;border-radius:5px;color:black;">
					<h4>Jawaban A</h4>
				</div>
