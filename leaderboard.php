    ...
    <body style="background-image: url('assets/backgrounds/normal.png');background-size: cover;">
		<div id="navbar">
			...
			<?php else: ?>
				...
				<div class="navbarcontent" onclick="window.location.href='leaderboard'" style="display:flex;align-items:center;padding:5px;padding-left:20px;margin-top:10px;background-color:#FFFFFF">
		...
		<div id="main">
			<div>
				<div>
					...
					<b style="margin-right:40px;float:right;font-size:2em;">#0</b>
				</div>
				<?php if (!isset($_SESSION['email'])) : ?>
			...
			<div>
				<div style="display:flex;margin-left:20px;margin-top:50px;">
					<center style="padding-left:20px;padding-right:70%;padding-top:5px;padding-bottom:20px;background-color:#D8D8D8;border:5px solid #D8D8D8;border-radius:5px;color:black;">
						<div style="display:flex;align-items:center;">
							#1
							<img style="margin-left:10px;" src="assets/icons/user.png" width="36px" height="36px">
							<span style="margin-left:5px;">User</span>
							<img style="margin-left:300%" src="assets/icons/checkmark.png" width="36px" height="36px">
							<span style="margin-left:5px;">0</span>
							<img style="margin-left:10px" src="assets/icons/time.png" width="36px" height="36px">
