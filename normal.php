...
<html>
    ...
    <body style="background-image: url('assets/backgrounds/normal.png');background-size: cover;">
		<div id="navbar">
			...
			<div class="navbarcontent" onclick="window.location.href='normal'" style="display:flex;align-items:center;padding:5px;padding-left:20px;margin-top:10px;background-color:#FFFFFF">
			...
			<div>
				<div style="display:flex;margin-left:20px;margin-top:50px;">
					...
					<div style="display:inline-block">
						<div style="padding:60px 30px;padding-top:0px;margin-left:40px;background-color:#EF78B1;border:5px solid #EF78B1;border-radius:5px;color:white;">
							<center>
								<h4>Tentang Mode Biasa</h4>
							</center>
							Pada mode ini, anda akan menjawab pertanyaan-pertanyaan sebanyak mungkin tanpa batas waktu. Anda akan kalah apabila menjawab dengan salah sebanyak tiga kali.
						</div>
						<div onclick="window.location.href='normal_game'" style="margin-top:20px;padding:40px 30px;margin-left:40px;background-color:#7FC15F;border:5px solid #7FC15F;border-radius:5px;color:white;">
							<center>
								<h1>Main</h1>
							</center>
						</div>
