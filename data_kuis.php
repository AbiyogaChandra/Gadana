...
<html>
    ...
    <body>
		<div id="navbar">
			...
			<div class="navbarcontent" onclick="window.location.href='data_kuis'" style="display:flex;align-items:center;padding:5px;padding-left:20px;margin-top:10px;background-color:#FFFFFF">
				Data Kuis
			</div>
		...
		<div id="main">
			...
			<div style="display:flex;align-items:center;margin-top:40px;">
				<img src="assets/icons/new.png" width="36px" height="36px"><b style="margin-left:5px">Baru</b>
			</div>
			<div style="display:flex;align-items:center;margin-top:5px;padding:10px;background-color:#D8D8D8;border:5px solid #D8D8D8;border-radius:5px;">
